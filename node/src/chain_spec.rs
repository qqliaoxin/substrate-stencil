...
use sp_core::{crypto::UncheckedInto, sr25519, Pair, Public,storage::Storage, Pair, H160, U256};
...
fn testnet_genesis(
	...
	use node_template_runtime::{
		 BalancesConfig, EVMConfig, EthereumChainIdConfig, GrandpaConfig, SudoConfig,
		SystemConfig,
	};
	...
	GenesisConfig {
		...
		// EVM compatibility
		evm_chain_id: EthereumChainIdConfig { 42 },
